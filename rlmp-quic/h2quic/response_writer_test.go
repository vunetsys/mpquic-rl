...
func newMockStreamPriority(id protocol.StreamID, priority *protocol.Priority) *mockStream {
	s := &mockStream{
		id:          id,
		priority:    priority,
		unblockRead: make(chan struct{}),
...
func newMockStreamPrioritySize(id protocol.StreamID, priority *protocol.Priority) *mockStream {
	s := &mockStream{
		id:          id,
		priority:    priority,
		unblockRead: make(chan struct{}),
...
func (s *mockStream) Priority() *protocol.Priority          { return s.priority }
func (s *mockStream) Size() protocol.ByteCount              { return s.size }
func (s *mockStream) Context() context.Context              { return s.ctx }
func (s *mockStream) LenOfDataForWriting() protocol.ByteCount {
	return protocol.ByteCount(s.dataWritten.Len())
}
