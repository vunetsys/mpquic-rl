        ...
        def testsMultipath(**kwargs):
            def test(**kwargs):
                xpDict = {
                    ...
                    HTTPS_RANDOM_SIZE: "26",  # default to PRIORITY_HIGH
                    ...
                    HTTPS_RANDOM_SIZE3: "373",
                    PRIORITY_3: "24",
                    DEPENDENCY_3: "0",
                    HTTPS_RANDOM_SIZE4: "59",
                    PRIORITY_4: "24",
                    DEPENDENCY_4: "0",
                    HTTPS_RANDOM_SIZE5: "97",
                    PRIORITY_5: "16",
                    DEPENDENCY_5: "0",
                }
...
def launchTests(times=1):
    mptcpTopos = [{'netem': [(0, 0, 'loss 0.00%'), (1, 0, 'loss 0.00%'), (2, 0, 'loss 0.00%')], 'paths': [{'queuingDelay': '0', 'delay': '200.000000', 'bandwidth': '1'}, {'queuingDelay': '0', 'delay': '200.000000', 'bandwidth': '1'}, {'queuingDelay': '0', 'delay': '200.000000', 'bandwidth': '1'}]}]
