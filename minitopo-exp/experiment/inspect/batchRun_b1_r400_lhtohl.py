...
### the first path setting is the initial path
### use the second path setting in singlepath as the fixed path
line_pathmanager_rtt_num = 162
line_pathmanager_rtt_num2 = 256
line_pathmanager_rtt_num3 = 323

line_pathmanager_bandwidth_num = 163
line_pathmanager_bandwidth_num2 = 257
line_pathmanager_bandwidth_num3 = 324

###### path_manager bandwidth line
###### path_manager rtt line
line_pathmanager_fixed_rtt_num = 165
line_pathmanager_fixed_rtt_num2 = 260
line_pathmanager_fixed_rtt_num3 = 327

line_pathmanager_fixed_bandwidth_num = 166
line_pathmanager_fixed_bandwidth_num2 = 261
line_pathmanager_fixed_bandwidth_num3 = 328
...
######  PROJECT List
PROJECT_LIST = ['quic-go','mp-quic']
######  set bandwidth & delay list
fixed_bandwidth = 1
fixed_rtt = 400
        ...
        for line in lines:
            if counter == line_singlepath_PROJECT_num:
                ...
                if counter == line_singlepath_bandwidth_num:
                    fw.write('    mptcpTopos = [{\'netem\': [(0, 0, \'loss 0.00%%\'), (1, 0, \'loss 0.00%%\')], \'paths\': [{\'queuingDelay\': \'0\', \'delay\': \'%f\''%(float(delay)/2.0)+', \'bandwidth\': \'%d\''%bandwidth+'}, {\'queuingDelay\': \'0\', \'delay\': \'%f\''%(float(fixed_rtt)/2.0)+', \'bandwidth\': \'%d\'}]}]\n'%fixed_bandwidth)
                else:
                    fw.write(line)
            counter = counter+1
        fr.close()
