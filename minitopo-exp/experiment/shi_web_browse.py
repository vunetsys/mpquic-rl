        ...
        def testsMultipath(**kwargs):
            def test(**kwargs):
                xpDict = {
                    ...
                    JSON_FILE: "www.baidu.com_",   # specify websites to download
                    ...
                    HTTPS_RANDOM_SIZE: "9",  # default to PRIORITY_HIGH
...
def launchTests(times=1):
    mptcpTopos = [{'netem': [(0, 0, 'loss 0.00%'), (1, 0, 'loss 0.00%')], 'paths': [{'queuingDelay': '0', 'delay': '5.000000', 'bandwidth': '25'}, {'queuingDelay': '0', 'delay': '5.000000', 'bandwidth': '25'}]}]
